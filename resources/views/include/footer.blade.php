    ...
    <div class="footer-wrapper w-full bg-primary-900 pt-[90px] overflow-hidden relative">
        <div class="theme-container mx-auto">
            <div class="relative z-10">
                        ...
                        <div class="flex space-x-2.5 items-center">
                            <a href="https://www.facebook.com/">
                                <div
                                    ...
                                    <span class="">
                                        <svg class="fill-current" width="10" height="16" viewBox="0 0 10 16"
                            ...
                            <a href="https://www.facebook.com/">
                                <div
                                    class="w-[30px] h-[30px] rounded bg-primary-500 flex justify-center items-center hover:bg-white text-white hover:text-primary-900 common-trans">
                                    <span class="">
                                        <svg width="14" class="fill-current" height="15" viewBox="0 0 14 15"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            <a href="https://www.facebook.com/">
                                <div
                                    class="w-[30px] h-[30px] rounded bg-primary-500 flex justify-center items-center hover:bg-white text-white hover:text-primary-900 common-trans">
                                    <span class="">
                                        <svg width="15" class="fill-current" height="15" viewBox="0 0 15 15"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            <a href="https://www.facebook.com/">
                                <div
                                    class="w-[30px] h-[30px] rounded bg-primary-500 flex justify-center items-center hover:bg-white text-white hover:text-primary-900 common-trans">
                                    <span class="">
                                        <svg width="16" class="fill-current" height="14" viewBox="0 0 16 14"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                    ...
                    <div class="sm:col-span-8 col-span-12">
                        <div
                            ...
                            <div class="quick-links">
                                <div class="mb-[30px]">
                                    <span class="text-lg text-white font-bold spline-sans leading-7 mb-2.5 block">Quick
                                        Links</span>
                                ...
                                <div class="flex space-x-8">
                                    <ul>
                                        ...
                                        <li class="mb-2.5">
                                            <a href="about.html">
                                                <span
                                                    class="text-white text-base leading-7 hover:underline common-trans capitalize">About
                                                    Us</span>
                                            </a>
                                        </li>
                                        <li class="mb-2.5">
                                            <a href="services.html">
                                                <span
                                                    class="text-white text-base leading-7 hover:underline common-trans capitalize">Service</span>
                                            </a>
                                        </li>
                                        <li class="mb-2.5">
                                            <a href="project.html">
                                                <span
                                                    class="text-white text-base leading-7 hover:underline common-trans capitalize">Portfolio</span>
                                            </a>
                                        </li>
                                        <li class="mb-2.5">
                                            <a href="blogs.html">
                                                <span
                                                    class="text-white text-base leading-7 hover:underline common-trans capitalize">Blogs</span>
                                            </a>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li class="mb-2.5">
                                            <a href="contact.html">
                                                <span
                                                    class="text-white text-base leading-7 hover:underline common-trans capitalize">Support</span>
                                            </a>
                                        </li>
                                        <li class="mb-2.5">
                                            <a href="contact.html">
                                                <span
                                                    class="text-white text-base leading-7 hover:underline common-trans capitalize">Terms
                                                    of Use</span>
                                            </a>
                                        </li>
                                        <li class="mb-2.5">
                                            <a href="faq.html">
                                                <span
                                                    class="text-white text-base leading-7 hover:underline common-trans capitalize">Privacy
                                                    Policy</span>
                                            </a>
                                        </li>
                                        <li class="mb-2.5">
                                            <a href="contact.html">
                                                <span
                                                    class="text-white text-base leading-7 hover:underline common-trans capitalize">Help</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="service-links">
                                <div class="mb-[30px]">
                                    <span
                                        class="text-lg text-white font-bold spline-sans leading-7 mb-2.5 block">Services</span>
                                    <div class="w-[52px] h-[2px] bg-primary-500"></div>
                                </div>
                                <ul>
                                    <li class="mb-2.5">
                                        <a href="service-details.html">
                                            <span
                                                class="text-white text-base leading-7 hover:underline common-trans capitalize">Risk
                                                Assessment</span>
                                        </a>
                                    </li>
                                    <li class="mb-2.5">
                                        <a href="service-details.html">
                                            <span
                                                class="text-white text-base leading-7 hover:underline common-trans capitalize">Coverage
                                                Review</span>
                                        </a>
                                    </li>
                                    <li class="mb-2.5">
                                        <a href="service-details.html">
                                            <span
                                                class="text-white text-base leading-7 hover:underline common-trans capitalize">Claims
                                                Management</span>
                                        </a>
                                    </li>
                                    <li class="mb-2.5">
                                        <a href="service-details.html">
                                            <span
                                                class="text-white text-base leading-7 hover:underline common-trans capitalize">Liability
                                                Protection</span>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="contact-links">
                                <div class="mb-[30px]">
                                    <span
                                        class="text-lg text-white font-bold spline-sans leading-7 mb-2.5 block">Contact
                                        Us</span>
                                    <div class="w-[52px] h-[2px] bg-primary-500"></div>
                                </div>
                                <ul>
                                    <li class="mb-2.5">
                                        <a href="tel:+880 123 45 67 89">
                                            <div class="flex space-x-2.5 items-center">
                                                ...
                                                <span
                                                    class="text-white text-base leading-7 hover:underline common-trans capitalize">+880
                                                    123 45 67 89</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="mb-2.5">
                                        <a href="mailto:yourmail@gmail.com">
                                            <div class="flex space-x-2.5 items-center">
                                                ...
                                                <span
                                                    class="text-white text-base leading-7 hover:underline common-trans capitalize">yourmail@gmail.com</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="mb-2.5">
                                        <a href="mailto:yourmail@gmail.com">
                                            <div class="flex space-x-2.5 items-center">
                                                ...
                                                <span
                                                    class="text-white text-base leading-7 hover:underline common-trans capitalize">1212,
                                                    Lav Vegas, The Veg <br />
                                                    Street, USA</span>
                                            </div>
                                        </a>
                                    </li>
                ...
                <div class="w-full border-t border-[#E3E3E3] lg:py-[30px] py-3 flex items-center justify-between">
                    ...
                    <ul class="sm:flex hidden space-x-[30px] items-center">
                        <li>
                            <a href="faq.html">
                                <span
                                    class="text-white lg:text-base text-sm leading-7 hover:underline common-trans capitalize">Trams
                                    & Condition</span>
                            </a>
                        </li>
                        <li>
                            <a href="faq.html">
                                <span
                                    class="text-white lg:text-base text-sm leading-7 hover:underline common-trans capitalize">Privacy
                                    Policy</span>
                            </a>
                        </li>
                        <li>
                            <a href="contact.html">
                                <span
                                    class="text-white lg:text-base text-sm leading-7 hover:underline common-trans capitalize">Contact
                                    Us</span>
                            </a>
                        </li>
                    </ul>
        ...
        <div class="footer-shape absolute">
            <span>
                <svg width="920" height="841" viewBox="0 0 920 841" fill="none"
                    xmlns="http://www.w3.org/2000/svg" style="opacity: 0.1" class="gear">
                    <path
...
<!-- Mirrored from themedox.com/demo/insucom/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jun 2024 09:31:58 GMT -->
